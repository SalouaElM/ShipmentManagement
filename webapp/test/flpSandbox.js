		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#apshipmentmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apshipmentmanagement-display": {
								"semanticObject": "apshipmentmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ap.shipmentmanagement",
									"url": sap.ui.require.toUrl("ap/shipmentmanagement")
								}
							}
						}
					}
